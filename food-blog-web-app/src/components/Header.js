...
function Header(){
    return (
        <>
        <div className="container-fluid fixed-top" style={{backgroundColor: "blueviolet"}}>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <form className="d-flex col-md-7">
                        <input className="form-control me-2" type="search" placeholder="Search for product brands and more"
                            aria-label="Search" />
                        <button className="btn btn-primary" type="submit"><i className="bi bi-search"> Search</i>
                        </button>
                    </form>
